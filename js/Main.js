...
function runSimulation(){
	...
	if(isNaN(maxLife) || maxLife < 1){
		...
		document.getElementById("maxLifeLabel").innerHTML = "Max Life";
	} 

	var minLife = parseInt(document.getElementById("minLife").value,10);
	if(isNaN(minLife) || minLife > maxLife || minLife < 0){
		document.getElementById("minLifeLabel").innerHTML = "Please input an integer between 0 and max life";
		return;
	}else{
		document.getElementById("minLifeLabel").innerHTML = "Min Life";
	} 
